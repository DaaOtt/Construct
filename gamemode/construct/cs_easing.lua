...
function easing.easeIn(t, tMax, start, delta)
    return start + (delta * easeIn(t / tMax))
end

function easing.easeIn2(t, tMax, start, delta)
    return start + (delta * easeIn2(t / tMax))
end

function easing.easeOut(t, tMax, start, delta)
    return start + (delta * easeOut(t / tMax))
end

function easing.easeInOut(t, tMax, start, delta)
    return start + (delta * easeInOut(t / tMax))
end

function easing.easeOutIn(t, tMax, start, delta)
    return start + (delta * easeOutIn(t / tMax))
end

function easing.easeInBack(t, tMax, start, delta)
    return start + (delta * easeInBack(t / tMax))
end

function easing.easeOutBack(t, tMax, start, delta)
...
function easing.easeOutInBack(t, tMax, start, delta)
    return start + (delta * easeOutInBack(t / tMax))
end

function easing.easeInElastic(t, tMax, start, delta)
    return start + (delta * easeInElastic(t / tMax))
end

function easing.easeOutElastic(t, tMax, start, delta)
    return start + (delta * easeOutElastic(t / tMax))
end

function easing.easeInOutElastic(t, tMax, start, delta)
    return start + (delta * easeInOutElastic(t / tMax))
end

function easing.easeOutInElastic(t, tMax, start, delta)
    return start + (delta * easeOutInElastic(t / tMax))
end

function easing.easeInBounce(t, tMax, start, delta)
    return start + (delta * easeInBounce(t / tMax))
end

function easing.easeOutBounce(t, tMax, start, delta)
    return start + (delta * easeOutBounce(t / tMax))
end

function easing.easeInOutBounce(t, tMax, start, delta)
    return start + (delta * easeInOutBounce(t / tMax))
end

function easing.easeOutInBounce(t, tMax, start, delta)
